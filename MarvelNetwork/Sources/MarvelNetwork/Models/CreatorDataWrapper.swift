...
public struct CreatorDataWrapper: Codable, Hashable {
    ...
    public init(code: Int? = nil, status: String? = nil, copyright: String? = nil, attributionText: String? = nil, attributionHTML: String? = nil, data: CreatorDataContainer? = nil, etag: String? = nil) {
        self.code = code
        self.status = status
